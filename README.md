# ModuloJavaScriptEBAC
Modulo de apresentação do JavaScript. Nesse módulo o desafio conta em criar uma página web de uma calculadora de IMC, com estilização  e JavaScript integrado
Estrutura HTML
